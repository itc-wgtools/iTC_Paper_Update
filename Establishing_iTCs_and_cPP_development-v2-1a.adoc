= Establishing International Technical Communities and Developing collaborative Protection Profiles
:showtitle:
:imagesdir: images
:icons: font
:revnumber: 2.1
...
[DISCUSSION]
====
*QUESTION {counter:question}:* Does the creation of iTCs and subsequent production of cPPs/SDs need to involve the CCRA committees?
...
[DISCUSSION]
====
*QUESTION {counter:question}:* Does the CCDB/MC agree that we now have enough experience to reduce the constraints (even if this is done gradually)?
====
...
[DISCUSSION]
====
*QUESTION {counter:question}:* Can others now act as initiators of an iTC (e.g. industry as suggested at the recent CCDB meeting in Rome? Should there be any constraints imposed on who/how many and what should the process be (if CCDB/MC is still involved at some stage)  
====
...
[DISCUSSION]
====
*QUESTION {counter:question}:* Not many participants have been involved so far - can we identify the reason(s) and make improvements? 
====

[DISCUSSION]
====
*QUESTION {counter:question}:* What about the position statement and endorsement process - can that be changed/improved?
====
...
[DISCUSSION]
====
*QUESTION {counter:question}:* Suggested in Rome that industry should be able to create iTCs without needing a supporting CCRA Participant - is it time to allow this?
====
...
[DISCUSSION]
====
*QUESTION {counter:question}:* Recent iTCs have produced the ESRs without a CCDB WG - should we remove the requirement for a WG?
====
...
[DISCUSSION]
====
*QUESTION {counter:question}:* Approval by DB and endorsement by MC is an essential requirement - assuming no one wants to re-open CCRA - how do we make the process as efficient as possible?
====
...
[DISCUSSION]
====
*QUESTION {counter:question}:* The use of an interpretations group has been found useful by a number of iTCs and is part of the tools group support information - should it be included here?
====
...
[DISCUSSION]
====
*QUESTION {counter:question}:* Are there any "other bodies involved in policy making, standardization, or procurement" that could be identified and invited to be involved in endorsement (ISO?, ETSI, NATO?)
====
...
[DISCUSSION]
====
*QUESTION {counter:question}:* To make the position/endorsement process easier should there be templates produced by the tools group?
====
...
[DISCUSSION]
====
*QUESTION {counter:question}:* Should position and endorsement positions be shown on iTC pages or on portal?
====

[DISCUSSION]
====
*QUESTION {counter:question}:* Should collection of these statements now be an iTC responsibility?
====
...
[DISCUSSION]
====
*QUESTION {counter:question}:* Is it now time to allow other requirements (not only government) in the ESR and remove need for a WG?
====
...
[DISCUSSION]
====
*QUESTION {counter:question}:* Discussion needed regarding CCDB role in the case of overlaps and/or where there is no direct Participant interest in an industry suggested iTC?
====

image:figure3.png[Figure 3]
...
[DISCUSSION]
====
*QUESTION {counter:question}:* Remove the need for a WG (or identify it as a pre-iTC step without the requirement for Participant involvement)?
====
...
[DISCUSSION]
====
*QUESTION {counter:question}:* Block 9/10/11 will need to change if we remove need for a WG.
====

[DISCUSSION]
====
*QUESTION {counter:question}:* Consider how many iTCs the CCDB could usefully coordinate?
====
...
[DISCUSSION]
====
*QUESTION {counter:question}:* How to appoint a CCDB Liaison where no Participant interest has been identified (fairly allocated from a list?) 
====
...
[DISCUSSION]
====
*QUESTION {counter:question}:* Re-write Block 13 for the most likely case of pre-iTC/WG produces ESR etc. 
====
...
[DISCUSSION]
====
*QUESTION {counter:question}:* Does the SPD need public review as well as the cPP and SDs?   
====
...
[DISCUSSION]
====
*QUESTION {counter:question}:* The maintenance document was never produced - we now have some relevant experience (NIT etc.) Should we just incorporate in this document?. 
====
...
[DISCUSSION]
====
*QUESTION {counter:question}:* Does the CCMC operating procedure need to be changed?
====
...
[DISCUSSION]
====
*QUESTION {counter:question}:* How to incorporate the approach used now which combines first use approval with later CCMB study?
====

[DISCUSSION]
====
*QUESTION {counter:question}:* How best to ensure that CCMB/CCDB is aware of cPP/SD updates and is able to prioritise subsequent CCMB review effort?
====
...
[DISCUSSION]
====
*QUESTION {counter:question}:* Discuss how to identify and handle inactive iTCs?
